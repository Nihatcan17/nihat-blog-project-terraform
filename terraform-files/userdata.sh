...
git clone https://github.com/Nihatcan17/nihat-blog-project.git
cd /home/ubuntu/terraform-capstone-project
pip3 install -r requirements.txt
cd /home/ubuntu/terraform-capstone-project/src
sed -i "s/'your DB password without any quotes'/${rds-passwd}/g" .env
cd /home/ubuntu/terraform-capstone-project/src/cblog
